...
- Once the music card fades out, compact passage controls keep play/pause, mute and exit available until the salon's controls take over. Manual pause, global mute, Escape and return navigation retain their existing behavior. These transition and visualizer refinements do not add another discovery: four secrets are implemented and two remain planned.
